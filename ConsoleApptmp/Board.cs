    ...
    class Board
    {
        ...
        public int Evaluate()
        {
            ...
            for (int k = 0; k < length; k++)
            {
                ...
                {
                    int value = Dijkstra(Grid[k, 0], Kind.Red);
        ...
        public int Dijkstra(Cell start, Kind type)
        {
            ...
            while (openNodes.Count > 0)
            {
                ...
                if ((type == Kind.Blue && currentCell.I == length - 1) || 
                    (type == Kind.Red && currentCell.J == length - 1))
                {
                    break;
                }
        ...
        private void GetInitialBoard()
        {
            for (int i = 0; i < length; i++)
            {
                if (i % 2 == 0)
                {
                    ...
                    {
                        Grid[i, j] = new Cell(i, j, Kind.Red);
